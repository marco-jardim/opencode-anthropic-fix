...
function calculateHybridScore(account, maxTokens) {
  ...
  // QA fix M17: lastUsed=0 means never-used; treat as 0 freshness bonus instead of max
  const secondsSinceUsed = account.lastUsed > 0 ? (Date.now() - account.lastUsed) / 1000 : 0;
