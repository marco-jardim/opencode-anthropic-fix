...
describe("model detection", () => {
  ...
  it("detects 1M-context eligibility and explicit context markers", () => {
    expect(isEligibleFor1MContext("claude-sonnet-4-5")).toBe(true);
    expect(isEligibleFor1MContext("claude-opus-4-6[1m]")).toBe(true);
    expect(hasOneMillionContext("claude-opus-4-6-1m")).toBe(true);
    expect(hasOneMillionContext("claude-opus-4-6[1m]")).toBe(false);
    expect(hasOneMillionContext("claude-opus-4-6")).toBe(false);
  });
