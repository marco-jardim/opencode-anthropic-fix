...
// mirrors request-headers.mjs `ANTHROPIC_SDK_VERSION` ("0.94.0"); hardcoded here
// to avoid coupling the OAuth path to the messages-header module.
 ...
 * live `oauth.sdk_token_useragent` config flag is read (default false).
